    ...
    const chatCompletion = await this.openai.createChatCompletion({
      ...
      messages: [
        ...
        },
        {
          role: "user",
          content:
            "Voy a proporcionarte contexto sobre Rafael Molina,\n" +
            "contesta las siguientes preguntas utilizando la informacion del contexto,\n" +
            "no menciones que el contexto existe:",
        },
        {
          role: "assistant",
          content: "Este es el contexto:,\n" + context,
        },
        {role: "user", content: text},
      ],
    });
